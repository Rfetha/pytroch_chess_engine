...
with open("/content/pytroch_chess_engine/models/heavy_move_to_int", "rb") as file:
...
model.load_state_dict(torch.load("/content/pytroch_chess_engine/models/TORCH_50EPOCHS.pth"))
model.to(device)
